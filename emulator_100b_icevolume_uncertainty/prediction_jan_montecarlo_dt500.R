...
x_vol_full=read.table('emulice_full_dt500.txt')  #read the ice volume and the year for the entire length of the experiment
...
x_ice_1=x_vol_full[[(index-8001)/2,2]]      	 #ice volume time step -1, index-8001/2 for dt = 500 years and index-8001/8 for dt = 2000 years

if((index-8001)/2 < 2){
index_1=index
} else {
index_1=index-2				      	 # previous index is index-2 for dt = 500 years and index-8 for dt = 2000 years
}
