...
x_ice_1=x_vol[[2]]    		    #ice volume as the fifth variable
x_ice_2=x_vol[[3]]    		    #ice area as the sixth variable
...
var5=x_ice_1/sx5		    #read the value of the ice sheet parameter (ice volume here) at the current year and normalize
var6=x_ice_2/sx6		    #read the value of the ice sheet parameter (ice area here) at the current year and normalize

# make vector of all input variables at the current year
x=cbind(var1,var2,var3,var4,var5,var6)
