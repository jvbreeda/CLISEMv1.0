...
for (i in Exp_list_A) {
       	filepathA=file.path('..','output_emul_20geom',paste(Exp1,i,sep=""),paste(prefix,month,suffix,sep=""))
...
for (i in Exp_list_B) {
        filepathB=file.path('..','output_emul_20geom',paste(Exp2,i,sep=""),paste(prefix,month,suffix,sep=""))
...
for (i in Exp_list_C) {
        filepathC=file.path('..','output_emul_20geom',paste(Exp3,i,sep=""),paste(prefix,month,suffix,sep=""))
...
for (i in Exp_list_D) {
       filepathD=file.path('..','output_emul_20geom',paste(Exp4,i,sep=""),paste(prefix,month,suffix,sep=""))
