...
# read the latitude and longitude on the ice sheet model grid
       filepathGRID=file.path('..','output_emulator_12b',"AISM40_eot.nc")
...
for (i in Exp_list_A) {
       	filepathA=file.path('..','output_emulator_12b',paste(Exp1,i,sep=""),paste(prefix,month,suffix,sep=""))
...
for (i in Exp_list_B) {
        filepathB=file.path('..','output_emulator_12b',paste(Exp2,i,sep=""),paste(prefix,month,suffix,sep=""))
...
for (i in Exp_list_C) {
        filepathC=file.path('..','output_emulator_12b',paste(Exp3,i,sep=""),paste(prefix,month,suffix,sep=""))
...
for (i in Exp_list_D) {
       filepathD=file.path('..','output_emulator_12b',paste(Exp4,i,sep=""),paste(prefix,month,suffix,sep=""))
